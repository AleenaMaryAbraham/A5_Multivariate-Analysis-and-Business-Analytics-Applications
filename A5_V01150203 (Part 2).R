...
survey_df<-read.csv('C:/Users/Aleena Mary Abraham/OneDrive/Desktop/SCMA632_2025/DATA/Survey.csv',header=TRUE)
sur_int=survey_df[,20:46] 

#B) Carry out cluster analysis and characterize the respondents based on their background variables. 
library(cluster) 
library(factoextra) 
show(sur_int) 
